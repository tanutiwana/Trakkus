...
public class UserProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        userProfile = FirebaseDatabase.getInstance().getReference(Constant.USER_INFORMATION).child(Constant.userProfile.getUid());
        ...
        friend_remove_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View view) {
                ...
                showDialogRequest(Constant.userProfile);
    ...
    private void showDialogRequest (final User user) {
        ...
        alertDialog.setIcon(R.drawable.ic_close_black_48dp);
        ...
        alertDialog.setPositiveButton("Remove", new DialogInterface.OnClickListener() {
            ...
            public void onClick (DialogInterface dialogInterface, int i) {
                ...
                DatabaseReference friendList_remove_from_both = FirebaseDatabase.getInstance()
                        ...
                        .child(user.getUid())
                        .child(Constant.ACCEPT_LIST);
                friendList_remove_from_both.child(Constant.loggedUser.getUid()).removeValue();
