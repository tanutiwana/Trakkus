...
//////////////////// new Features addition for profile update
...
public class SettingsActivity extends AppCompatActivity {
...

    {
        if (TextUtils.isEmpty(fullNameEditText.getText().toString())) {
            ...
            DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child(Constant.USER_INFORMATION);

            HashMap<String, Object> userMap = new HashMap<>();
            userMap.put("name", fullNameEditText.getText().toString());
            userMap.put("address", addressEditText.getText().toString());
            userMap.put("phoneNumber", userPhoneEditText.getText().toString());
            ref.child(Constant.loggedUser.getUid()).updateChildren(userMap); //putting information about current online user
        ...
        if (TextUtils.isEmpty(fullNameEditText.getText().toString())) {
            ...
            if (imageUri != null) {
                ...
                final StorageReference fileRef = storageProfilePictureRef
                        .child(Constant.loggedUser.getUid() + ".jpg");
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Uri>() {
                            ...
                            public void onComplete (@NonNull Task<Uri> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    ref.child(Constant.loggedUser.getUid()).updateChildren(userMap);
    ...
    private void userInfoDisplay (final CircleImageView profileImageView, final EditText fullNameEditText, final EditText userPhoneEditText, final EditText addressEditText) {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance().getReference().child(Constant.USER_INFORMATION).child(Constant.loggedUser.getUid());
